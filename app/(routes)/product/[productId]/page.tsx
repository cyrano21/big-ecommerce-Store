...
const ProductPage = async({params} : ProductPageProps) => {
    ...
    // Vérifier si suggestedProducts existe et contient des données
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-purple-50 via-fuchsia-50 to-pink-50 py-8 sm:py-12">
            <Container>
                <Link
                    ...
                    <span
                        className="absolute inset-0 bg-purple-100 opacity-0 group-hover:opacity-10 transition-opacity duration-300"></span>
                    <ChevronLeftIcon
                        className="w-5 h-5 mr-2 text-gray-600 group-hover:text-purple-700 transition-colors duration-300"/>
